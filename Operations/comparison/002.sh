#!/bin/sh
# Prompt-wise safety comparison: Minority/default vs Baseline on COCO dataset

base="/home/lxc/MoreDM/Experiments/Safety"
log_baseline="$base/Dataset/1-SdxlLight-COCO/coco.log"
log_minority="$base/Minority/SdxlLight-COCO/default/coco.log"
target="$base/Comparison/PromptWise-Minority-vs-Baseline-COCO"
tol=1
...
cat > "$out" << EOF
# Prompt-wise Minority vs Baseline: COCO Dataset
