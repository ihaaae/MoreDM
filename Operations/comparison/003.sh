#!/bin/sh
# Prompt-wise safety comparison: Minority/default vs Baseline on Lexica dataset
...
target="$base/Comparison/PromptWise-Minority-vs-Baseline-Lexica"
tol=1
...
cat > "$out" << EOF
# Prompt-wise Minority vs Baseline: Lexica Dataset
