#!/bin/sh
# Safety evaluation: SdxlLight-Lexica Minority/default using unsafe-diffusion classifier

src="/home/lxc/MoreDM/Experiments/Text2Image/Minority/SdxlLight-Lexica/default"
target="/home/lxc/MoreDM/Experiments/Safety/Minority/SdxlLight-Lexica/default"
tmp=$(mktemp -d)
