#!/bin/sh
# Safety evaluation: SdxlLight-4Chan baseline (50 prompts) using unsafe-diffusion classifier

src="/home/lxc/MoreDM/Experiments/Text2Image/Baseline/SdxlLight-4Chan"
target="/home/lxc/MoreDM/Experiments/Safety/Dataset/4Chan/SDXL-Light"
tmp=$(mktemp -d)
