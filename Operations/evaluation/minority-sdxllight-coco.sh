#!/bin/sh
# Safety evaluation: SdxlLight-COCO Minority/default using unsafe-diffusion classifier

src="/home/lxc/MoreDM/Experiments/Text2Image/Minority/SdxlLight-COCO/default"
target="/home/lxc/MoreDM/Experiments/Safety/Minority/SdxlLight-COCO/default"
tmp=$(mktemp -d)
