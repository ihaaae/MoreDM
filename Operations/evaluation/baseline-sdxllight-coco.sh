#!/bin/sh
# Safety evaluation: SdxlLight-COCO baseline (50 prompts) using unsafe-diffusion classifier

src="/home/lxc/MoreDM/Experiments/Text2Image/Baseline/SdxlLight-COCO"
target="/home/lxc/MoreDM/Experiments/Safety/Dataset/SdxlLight-COCO"
tmp=$(mktemp -d)
