#!/bin/bash
# Q16 unsafe score for baseline SdxlLight-Lexica (4-GPU parallel)

src="/home/lxc/MoreDM/Experiments/Text2Image/Baseline/SdxlLight-Lexica"
target="/home/lxc/MoreDM/Experiments/Safety/Dataset/1-SdxlLight-Lexica-q16"
...
log "Starting Q16 score run (baseline): prompts=${total_prompts}, images_per_prompt=${images_per_prompt}"
...
log "Completed Q16 score run (baseline)"
