#!/bin/sh
# Generate 20 more BASELINE images (11-30) for attribution2 families.
...
echo "Generating baseline images 11-30 for $count families across 4 GPUs..."
...
wait
echo "Baseline generation (11-30) complete."
