...
# CLIP prompt-image similarity scoring for vanilla SD3 Template images.
SRC=Experiments/Safety/Vanilla/Sd3-Template/default
TARGET=Experiments/Safety/Vanilla/Sd3-Template/default-clip
